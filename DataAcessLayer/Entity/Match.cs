...
namespace DataAccessLayer
{
    class Match : IMatch
    {
        ...
        public Match(ITeam team1, ITeam team2, IStadium nStadium, IReferee nReferee, int team1Score, int team2Score, ICup cup, DateTime matchDate, List<ISpectator> spectators)
        {
            Team1 = team1;
            Team2 = team2;
            Stadium = nStadium;
        ...
        {
            return Team1 + " vs " + Team2 + ", " + MatchDate.ToShortDateString();
        }
